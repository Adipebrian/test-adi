...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add Data Transaksi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Add Data Transaksi</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="/data/add" method="post">
                        <?= csrf_field() ?>
                        <button type="submit" class="btn btn-success m-2">Add Data</button>
                    </form>
                </div>
                <!-- /.col -->
            </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Draft Data Transaksi</h3>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($result as $r) : ?>
                                            <tr>
                                                ...
                                                <td><?= $r->kode ?></td>
                                                <td>
                                                    <a href="/data/add_sales/<?= $r->kode ?>" class="btn btn-success">Edit</a>
    ...
    <div class="modal fade" id="modal-delete<?= $r->id ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/data/delete_sales" method="POST">
                    <?= csrf_field(); ?>
